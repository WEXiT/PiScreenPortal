...
window.I18N = {
  en: {
    ...
    "screens.none_detected": "No monitors detected. Is the X11 session running?",
    ...
    "settings.auth_note": "Simple HTTP basic auth. Password stored in plain text – do not reuse an important one.",
  ...
  de: {
    ...
    "screens.none_detected": "Keine Monitore erkannt. Läuft die X11-Session?",
    ...
    "settings.auth_note": "Einfacher Basic-Auth-Schutz. Passwort im Klartext gespeichert – bitte kein wichtiges wiederverwenden.",
